...
// iconify simple-icons:torbrowser — fmhy.net's [.onion] sub-link icon
// (upstream transformer.ts "i-simple-icons:torbrowser")
export const TorBrowserIcon = (props: IconProps) => {
