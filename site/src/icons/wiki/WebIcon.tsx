...
// iconify fluent:globe-32-filled — fmhy.net's Web platform indicator
// (upstream transformer.ts "i-fluent:globe-32-filled")
export const WebIcon = (props: IconProps) => {
  const { width, height, fill, ...svgProps } = useIconProps(props)

  return (
    <Svg width={width} height={height} viewBox="0 0 32 32" fill="none" {...svgProps}>
      <Path
