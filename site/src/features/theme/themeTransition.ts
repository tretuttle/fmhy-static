...
// isWeb, not just a window check: react-native defines global.window but not
// window.addEventListener, so this module-level listener would crash native at
// import time without the compile-time gate.
